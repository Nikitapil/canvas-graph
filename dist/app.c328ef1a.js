...
function chart(root, data) {
  ...
  function xAxis(xData, xRatio, yData) {
    ...
    var _loop = function _loop(i) {
      var x = i * xRatio;
      if ((i - 1) % step === 0) {
        ctx.fillText((0, _utils.toDate)(xData[i]), x, DPI_HEIGHT - 10);
      }
  ...
  function yAxis(yMin, yMax) {
    ...
    for (var i = 1; i <= ROWS_COUNT; i++) {
      ...
      ctx.fillText("".concat(text), 5, y + PADDING - 10);
...
function toCoords(xRatio, yRatio) {
  return function (col) {
    return col.map(function (y, idx) {
      return [Math.floor((idx - 1) * xRatio), Math.floor(DPI_HEIGHT - PADDING - y * yRatio)];
    }).slice(1);
  };
}
},{"./styles.scss":"styles.scss","./utils":"utils.js","./tooltip":"tooltip.js"}],"app.js":[function(require,module,exports) {
"use strict";

var _data = require("./data");
var _chart = require("./chart");
var myChart = (0, _chart.chart)(document.getElementById('chart'), (0, _data.getChartData)());
myChart.init();
